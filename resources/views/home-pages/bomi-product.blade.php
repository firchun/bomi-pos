            ...
            <div class="container mx-auto relative z-10">
                ...
                <p
                    ...
                    @else
                        ...
                        sempurna untuk bisnis Anda—cepat dan mudah!
                    @endif
                </p>
        ...
        <section class="mt-20 container mx-auto px-4 h-full" x-data="{ tab: 'account' }">
            ...
            <div class="flex justify-center items-center gap-4 mb-8">
                <div
                    ...
                    <!-- Tab: Account -->
                    <div id="tab-account" @click="tab = 'account'"
                    ...
                    <!-- Tab: Devices -->
                    <div id="tab-devices" @click="tab = 'devices'"
                    ...
                    <div
                        ...
                        <div>
                            ...
                            <ul class="text-neutral-900 dark:text-neutral-200  font-semibold space-y-2 text-lg">
                                ...
                                <li><i class="bi bi-check-square-fill text-white"></i> 1 Printer Bluetooth Struk Thermal
                                    58mm</li>
