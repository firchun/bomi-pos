...
@section('content')
    <div class="container mx-auto px-4 mt-[110px]">
        ...
        <!-- Breadcrumb -->
        <section
            class="rounded-2xl bg-white/50 text-purple-700 dark:text-white dark:bg-zinc-800/70 transitions-colors duration-300 p-5 w-full mb-5">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div class="md:col-span-2 bg-white/60 dark:bg-zinc-800/60 rounded-xl overflow-hidden shadow p-0">
                ...
                <div class="p-6">
                    <h1 class="text-3xl font-bold text-purple-700 mb-2">{{ $blog->title }}</h1>
            ...
            <div class="bg-white/60 dark:bg-zinc-800/60 rounded-xl p-6">
                <h2 class="text-xl font-semibold text-purple-700 mb-4">Blog Lainnya</h2>
                <ul class="space-y-3">
        ...
        <div class="mt-12 mb-10">
            <h2 class="text-2xl font-semibold text-purple-700 mb-6">Blog Terbaru</h2>
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
