                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <div class="text-mutted mt-3">
                                          @if (app()->getLocale() == 'en')
                                            The photo or flyer to be displayed on the advertisement is square 300 x 300 pixels, with a maximum size of 2 MB.
                                          @else
                                            Foto atau flyer yang akan ditampilkan pada iklan berbentuk persegi 300 x 300 pixel, dengan ukuran maksimal 2 MB.
                                          @endif
                                        </div>
                                    </div>
                                </div>
