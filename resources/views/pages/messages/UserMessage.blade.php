            ...
            <div class="section-body">
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-12 col-12 col-sm-12">
                        ...
                        <div class="mt-3">
                            <a href="https://wa.me/6282248493036?text=Halo%20tim%20BOMI%20POS%2C%20saya%20ingin%20bertanya%20tentang%20penggunaan%20aplikasi%20BOMI%20POS.%20Mohon%20bantuannya." class="btn btn-lg btn-success mb-3 btn-block" target="_blank">
                                <i class="fa-brands fa-whatsapp"></i> Support on Whatsapp
                            </a>
                            <div class="p-2 border rounded bg-light">
                                @if (app()->getLocale() == 'en')
                                    Please select one of our admin accounts to start your consultation with us. We’ll be
                                    happy to listen and help find a solution to your issue. Warm regards from BOMI POS.
                                @else
                                    Silahkan pilih salah satu akun dari admin untuk memulai konsultasi masalah anda pada
                                    kami, kami akan dengan senang hati mendengar dan mencari solusi atas masalah anda, salam
                                    dari kami BOMI POS
                                @endif
                            </div>
                        </div>
        ...
        $(document).ready(function() {
            ...
            const loadLastMessagesForAllAdmins = () => {
                $('.admin-chat').each(function() {
                    ...
                    $.ajax({
                        ...
                        error: (xhr) => {
                            console.error('Error loading last message for admin:', xhr
                                .responseText);
                        },
                    });
                });
            ...
            const updateLastMessageInList = (messages) => {
                if (messages.length > 0) {
                    ...
                    const lastMessageSpan = $(`.admin-chat[data-admin-id="${currentAdminId}"]`).find(
                        '.text-muted');
