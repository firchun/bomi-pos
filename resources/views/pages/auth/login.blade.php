        ...
        <form method="POST" action="{{ route('login') }}" class="space-y-5">
            ...
            <div>
                <div class="flex justify-between">
                    ...
                    <a href="{{route('password.request')}}" class="block text-sm font-medium text-purple-700  hover:underline">Forgot Password</a>
                </div>
                <div class="relative">
                    <input type="password" name="password" id="password"
                        ...
                        required>
                    <button type="button" id="togglePassword" class="absolute inset-y-0 right-2 flex items-center text-zinc-500 dark:text-zinc-300">
