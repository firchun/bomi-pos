...
@section('main')
    <div class="bg-white/70 dark:bg-zinc-800/70 shadow-md rounded-2xl px-8 py-6 mt-10">
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <!-- Confirm Password -->
            <div class="mb-4">
                <label for="password_confirmation" class="block text-sm font-medium mb-1 dark:text-gray-200">Confirm
                    Password</label>
            ...
            <div class="mt-6">
                <button type="submit" class="w-full bg-primary text-white py-2 rounded-2xl hover:bg-purple-700 transition">
                    Sign Up
                </button>
            </div>
        </form>
